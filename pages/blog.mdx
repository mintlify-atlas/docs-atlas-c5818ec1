...
sidebarTitle: "Blog"
description: "The /blog route lists SAP and web-dev articles from a local JSON file, with category tabs, tag chips, free-text search, and full post view at /blog/:slug."
---
