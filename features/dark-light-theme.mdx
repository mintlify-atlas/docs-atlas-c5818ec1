...
description: "Hector Portfolio uses a React context-based theme system with localStorage persistence. Consume useDarkMode to read the current mode in any component."
---
