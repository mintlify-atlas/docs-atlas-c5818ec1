---
title: "BlogService: Blog Data Access Layer"
sidebarTitle: "Blog Service"
description: "BlogService is a static class in src/services/blogService.js that reads posts.json and exposes async methods for fetching, filtering, searching, and commenting."
---
...
<Note>
  Most methods call an internal `delay(300)` helper (`delay(200)` for lighter operations) before resolving. This intentional pause mimics real API latency so that loading states in the UI are visible during development.
